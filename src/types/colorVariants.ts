export const colorVariants = {
  violet: {
    bg: 'bg-[#F6EEFF] dark:bg-boxdark',
    bgSub: 'bg-[#E5D9F2] dark:bg-boxdark-2',
    icon: 'bg-[#BF83FF] dark:bg-boxdark-2',
    btnSc: '',
    text: 'text-[#05004E] dark:text-white',
    btn: 'bg-[#BF83FF] hover:bg-[#A766E6] text-white dark:bg-boxdark-2 dark:hover:bg-graydark',
    inp: '',
  },
  white: {
  ...
  red: {
    ...
    bgSub: 'bg-[#F6E6E7] dark:bg-boxdark-2',
    icon: 'bg-[#FA5A7D] dark:bg-boxdark-2',
    btnSc:
      'text-[#FA5A7D] hover:text-[#E0496A] dark:text-white dark:hover:text-graydark',
    text: 'text-[#05004E] dark:text-white',
    btn: 'bg-[#FA5A7D] hover:bg-[#E0496A] text-white dark:bg-boxdark-2 dark:hover:bg-graydark',
    inp: 'dark:bg-boxdark dark:text-white text-[#05004E]',
  },
  orange: {
